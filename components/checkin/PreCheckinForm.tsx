...
import { submitPreCheckin } from "@/app/actions/checkin";
...
// ─── Constants & Questions ────────────────────────────────────────────────────
type QuestionType = "radio" | "checkbox" | "conditional" | "textarea";
...
const QUESTIONS: Question[] = [
    // Page 1
    {
        id: "q1", page: 1, type: "radio", allowOther: true,
        text: "1. What problem are you facing today?",
        options: ["Body pain", "Fever", "Cold / cough", "Headache", "Stomach pain", "Skin issue", "Weakness / tiredness", "Injury / accident", "Check-up (no issue)"]
    },
    {
        id: "q2", page: 1, type: "radio", allowOther: false,
        text: "2. How long have you had this issue?",
        options: ["Today", "1–2 days", "3–7 days", "More than a week", "More than a month"]
    },
    {
        id: "q3", page: 1, type: "radio", allowOther: false,
        text: "3. How serious does it feel?",
        options: ["Mild", "Moderate", "Severe"]
    },
    {
        id: "q4", page: 1, type: "radio", allowOther: true,
        text: "4. Where is the problem in your body?",
        options: ["Head", "Chest", "Stomach", "Back", "Arms", "Legs", "Skin", "Whole body"]
    },
    // Page 2
    {
        id: "q5", page: 2, type: "checkbox", allowOther: true,
        text: "5. Are you having any of these right now?",
        options: ["Fever", "Pain", "Swelling", "Vomiting", "Dizziness", "Breathing difficulty", "None"]
    },
    {
        id: "q6", page: 2, type: "radio", allowOther: false,
        text: "6. Did this start suddenly or slowly?",
        options: ["Suddenly", "Slowly", "Not sure"]
    },
    {
        id: "q7", page: 2, type: "radio", allowOther: true,
        text: "7. Does anything make it better or worse?",
        options: ["Gets worse at night", "Worse when moving", "Better with rest", "Better with medicine", "No change"]
    },
    {
        id: "q8", page: 2, type: "conditional", conditionalTrigger: "Yes", conditionalLabel: "What medicine?",
        text: "8. Have you taken any medicine for this?",
        options: ["Yes", "No", "Not sure"]
    },
    // Page 3
    {
        id: "q9", page: 3, type: "radio", allowOther: false,
        text: "9. Have you had this problem before?",
        options: ["Yes", "No"]
    },
    {
        id: "q10", page: 3, type: "checkbox", allowOther: true,
        text: "10. Do you have any ongoing health issues?",
        options: ["Diabetes", "Blood pressure", "Thyroid", "Heart problem", "None", "Not sure"]
    },
    {
        id: "q11", page: 3, type: "conditional", conditionalTrigger: "Yes", conditionalLabel: "What medicines are you taking?",
        text: "11. Are you currently taking any regular medicines?",
        options: ["Yes", "No"]
    },
    {
        id: "q12", page: 3, type: "conditional", conditionalTrigger: "Yes", conditionalLabel: "What allergies do you have?",
        text: "12. Any allergies (food / medicine)?",
        options: ["Yes", "No", "Not sure"]
    },
    // Page 4
    {
        id: "q13", page: 4, type: "radio", allowOther: false,
        text: "13. Have you visited a doctor for this already?",
        options: ["Yes", "No"]
    },
    {
        id: "q14", page: 4, type: "textarea",
        text: "14. What is your main concern today?",
        placeholder: "Explain in your own words..."
    },
    {
        id: "q15", page: 4, type: "textarea",
        text: "15. Anything else you want the doctor to know?",
...
// ─── Simple Navbar specifically for PreCheckin ────────────────────────────────
function FormNavbar() {
...
function StatusScreen({ type }: { type: string }) {
    const config: any = {
        already_submitted: { title: "Already Submitted", message: "You have already completed this form." },
        expired: { title: "Link Expired", message: "This link has expired. You can still walk in directly." },
        ...
        success: { title: "Submitted successfully", message: "Your doctor will review your responses before the appointment. See you soon!" },
    };
...
// ─── Main Form Component ──────────────────────────────────────────────────────
export default function PreCheckinForm({ token, status, session, appointmentInfo }: Props) {
    ...
    // --- Answer Handlers ---
    // Even for radio types, visual is tickbox, but logic remains mutually exclusive replacing
    ...
    const handleSubmit = async () => {
        ...
        const formattedAnswers = QUESTIONS.map(q => {
            ...
            if ((q.type === 'radio' || q.type === 'conditional') && finalAnswer === '__other__') {
                ...
                if (finalAnswer === q.conditionalTrigger) {
        ...
        // Add additional tracking info to answers
        const payload = {
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10 flex-1 w-full">
                {page === 1 && (
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 border-t-8 border-t-teal-600 p-6 sm:p-8 mb-6">
                        <h1 className="text-2xl sm:text-3xl font-medium text-slate-800 mb-4">Health Assessment</h1>
                        {appointmentInfo && (
                            <div className="text-[15px] sm:text-base text-slate-600 leading-relaxed space-y-2">
                                <p>For appointment with {appointmentInfo.doctorName || "Doctor"} on {appointmentInfo.date}{appointmentInfo.time ? ` at ${appointmentInfo.time}` : ''}.</p>
                                <p>Please fill out this form to help us understand your condition better before your visit.</p>
                            </div>
                        )}
                    </div>
                )}
                            ...
                            <div key={q.id} className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sm:p-8 transition-shadow hover:shadow-md">
                                ...
                                {q.type === 'conditional' && (
                                    <div className="space-y-4">
                                        ...
                                        {values[q.id] === q.conditionalTrigger && (
                                ...
                                {(q.type === 'radio' || q.type === 'conditional') && values[q.id] && (
