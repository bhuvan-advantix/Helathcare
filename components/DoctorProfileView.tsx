...
import { Phone, Mail, MapPin, User, Camera, Edit2, Calendar, X, Save, Loader2, Bell, Lock, Shield, Eye, Moon, Globe, ChevronRight, LogOut, Smartphone, Trash2, Settings, ChevronLeft, ChevronDown, AlertTriangle, Copy, Check, Briefcase, Award, Clock, FileText } from 'lucide-react';
...
export default function DoctorProfileView({ user, doctor }: ProfileViewProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        age: doctor?.dateOfBirth ? calculateAge(doctor.dateOfBirth) : (doctor?.age || ''),
        ...
        hospitalTiming: doctor?.hospitalTiming || '',
    ...
    const handleCancel = () => {
        if (isEditing) {
            setConfirmAction(() => () => {
                setIsEditing(false);
                setShowAvatarSelection(false);
                // Reset form with initial values (could be optimized)
                router.refresh();
            });
                ...
                return (
                    <div className="relative group w-full">
                        <textarea
                            ...
                            disabled={disabled}
                            rows={4}
                            className={`w-full bg-transparent border rounded-lg p-2 text-slate-900 focus:ring-1 focus:ring-teal-500 outline-none placeholder:text-slate-300 resize-none ${disabled ? 'opacity-70 cursor-not-allowed' : ''} ${className}`}
                        />
                    </div>
                );
            }
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-slate-500 font-medium mt-1">Manage your professional information and settings</p>
                    </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-between gap-4 border-b border-slate-100 pb-6">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <span className="text-slate-400 font-medium text-sm">Doctor ID:</span>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="px-4 py-2 bg-slate-50 rounded-2xl border border-slate-100 text-center min-w-[100px]">
                                        <span className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-0.5">Experience</span>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                            <span className="text-xs font-bold text-slate-400 uppercase block mb-2">Specialization</span>
                                            <EditableField
                                                name="specialization"
                                        ...
                                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                            <span className="text-xs font-bold text-slate-400 uppercase block mb-2">Degrees</span>
                                            <EditableField
                                                name="degree"
                                        ...
                                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                            <span className="text-xs font-bold text-slate-400 uppercase block mb-2">Clinic Name</span>
                                            <EditableField
                                                name="clinicName"
