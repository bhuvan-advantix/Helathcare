...
export const metadata = {
    ...
    description: "Interactive condition pathway visualising diagnosis, treatment, and health trends.",
};

export default async function DiagnosticDetailRoute({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!targetDiagnostic) redirect("/diagnostic");
